...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    vgg_layer3_out_scaled = tf.reshape(tf.multiply(vgg_layer3_out, 0.0001,
                                         name='vgg_layer3_out_scaled'), (-1,
                                                                         num_classes))
    vgg_layer4_out_scaled = tf.reshape(tf.multiply(vgg_layer4_out, 0.01,
                                         name='vgg_layer4_out_scaled'), (-1,
                                                                         num_classes))
    ...
    output = tf.layers.conv2d_transpose(conv1x1,
                                        num_classes,
                                        4,
                                        strides=(2, 2),
                                        padding='same',
